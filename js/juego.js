...
var Juego = {
    ...
    obstaculosCarretera: [
        ...
        new Obstaculo('imagenes/bache.png', 350, 450, 30, 30, 2),
        new Obstaculo('imagenes/bache.png', 400, 480, 30, 30, 2),
        new Obstaculo('imagenes/auto_verde_derecha.png', 840, 380, 30, 15, 3),
        new Obstaculo('imagenes/valla_horizontal.png', 760, 430, 30, 30, 6)
    ...
    enemigos: [
        new ZombieCaminante('imagenes/zombie1.png', 850, 200, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 700, 450, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 920, 250, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie1.png', 300, 120, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 500, 110, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie3.png', 367, 387, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png', 675, 689, 10, 10, 0.5, {desdeX: 0, hastaX: 960, desdeY: 0, hastaY: 577}),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 325, 90, 30, 1, {desdeX: 0, hastaX: 850, desdeY: 325, hastaY: 325}, 'h'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 20, 30, 90, 1, {desdeX: 644, hastaX: 644, desdeY: 20, hastaY: 480}, 'v'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 20, 30, 90, 1, {desdeX: 4, hastaX: 674, desdeY: 20, hastaY: 480}, 'v')
    ]
...
Dibujante.dibujarRectangulo('white', 760, 480, 125, 23);
...
Juego.moverEnemigos = function() {
    ...
    this.enemigos.forEach(function (ZombieCaminante) {
        ZombieCaminante.moverse();
    })

    this.enemigos.forEach(function(ZombieConductor) {
        ZombieConductor.moverse();
    })
};
